...
class EmailManagerApp:
    def __init__(self, master):
        ...
        # Buttons
        self.add_button = tk.Button(self.frame, text="Add Email", command=self.add_email, font=("Helvetica", 12), bg="green", fg="white")
        self.add_button.pack(side=tk.LEFT, padx=10)
        self.edit_button = tk.Button(self.frame, text="Edit Email", command=self.edit_email, font=("Helvetica", 12), bg="blue", fg="white")
        self.edit_button.pack(side=tk.LEFT, padx=10)
        self.delete_button = tk.Button(self.frame, text="Delete Email", command=self.delete_email, font=("Helvetica", 12), bg="red", fg="white")
    ...
    def save_emails(self):
        with open(r"C:\Users\Eitan\PycharmProjects\email\code\blacklist_file.txt", "w") as file:
