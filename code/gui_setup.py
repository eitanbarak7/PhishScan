...
def detect_phishing_window(email_listbox, emails):
    ...
    from_label = tk.Label(phishing_window, text=f"From: {email.sender}", font=("Arial", 14), bg="#f0f0f0", padx=10,
                          pady=5)
    from_label.grid(row=0, column=0, sticky="w")

    subject_label = tk.Label(phishing_window, text=f"Subject: {email.subject}", font=("Arial", 14), bg="#f0f0f0",
                             padx=10, pady=5)
    subject_label.grid(row=1, column=0, sticky="w")

    date_label = tk.Label(phishing_window, text=f"Date: {email.date}", font=("Arial", 14), bg="#f0f0f0", padx=10,
                          pady=5)
